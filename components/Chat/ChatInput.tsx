...
export const ChatInput: FC<Props> = ({
  ...
  return (
    <div className="absolute bottom-0 left-0 w-full border-transparent bg-gradient-to-b from-transparent via-white to-white pt-6 dark:border-white/20 dark:via-[#343541] dark:to-[#343541] md:pt-2">
      ...
      <footer className='items-center justify-center py-4'>
        <h1 className='text-center font-medium text-[12px] tracking-wide text-gray-700 dark:text-gray-400'>Copyright &copy; 2023 SAP-GPT-InsightAnalyzer. All Rights Reserved.</h1>
      </footer>
    </div>
  );
};
